...
See its [environment variables](https://yourls.org/docs/guide/essentials/configuration) for a complete list of YOURLS's config options that you can put in `yourls_environment_variables_additional_variables`.
